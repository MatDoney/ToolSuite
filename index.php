            ...
            <div class="pane-card">
              ...
              <div class="pane-body">
                <div id="pdf-split-config-panel" style="display: none;">
                  <div style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.25); border-radius: var(--radius-sm); padding: 1rem; margin-bottom: 1.5rem;">
                    <div id="pdf-split-file-name" style="font-weight: 700;">Document.pdf</div>
                    <div id="pdf-split-file-info" style="font-size: 0.85rem; color: var(--text-muted);">0 page(s)</div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div style="font-size: 0.78rem; color: var(--text-muted); margin-top: 0.35rem;">
                      💡 Exemples : <code>1-5</code> (pages 1 à 5), <code>1, 3, 5</code> (pages impaires), <code>2-4, 7</code>.
                    </div>
                  </div>

                  <button class="btn btn-primary btn-lg" id="pdf-split-action-btn" style="width: 100%; margin-top: 1rem;">
                    <span>📥</span> Extraire et Télécharger le PDF
                  </button>
                </div>

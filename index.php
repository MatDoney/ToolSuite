      ...
      <main class="content-container">
        ...
        <section id="dashboard-view">
          ...
          <div class="hero-banner">
            ...
            <p class="hero-desc">
              30 outils professionnels pour vos documents, images, code, rédaction et tâches du quotidien. 
          ...
          <div class="category-filter-bar">
            <button class="filter-btn active" data-category="all">⚡ Tous les outils (30)</button>
  ...
  <div class="modal-backdrop" id="search-modal-backdrop">
    <div class="search-modal">
      <div class="search-modal-header">
        <span>🔍</span>
        <input type="text" id="search-modal-input" class="search-modal-input" placeholder="Rechercher parmi les 30 outils...">

      ...
      <main class="content-container">
        ...
        <section id="dashboard-view">
          ...
          <div class="category-filter-bar">
            <button class="filter-btn active" data-category="all">⚡ Tous les outils (16)</button>
  ...
  <div class="modal-backdrop" id="search-modal-backdrop">
    <div class="search-modal">
      <div class="search-modal-header">
        <span>🔍</span>
        <input type="text" id="search-modal-input" class="search-modal-input" placeholder="Rechercher parmi les 16 outils...">
